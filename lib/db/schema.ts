...
export const teamMembers = pgTable('team_members', {
  ...
  teamUserUnique: unique('team_user_unique_idx').on(table.teamId, table.userId),
...
export const activityLogs = pgTable('activity_logs', {
  ...
  teamTimestampIdx: index('activity_logs_team_timestamp_idx').on(table.teamId, table.timestamp),
}));
...
export const invitations = pgTable('invitations', {
  ...
  teamEmailPendingUnique: unique('team_email_invitation_unique_idx').on(table.teamId, table.email, table.status),
...
export const messages = pgTable('messages', {
  ...
  mediaFileLength: bigint('media_file_length', { mode: 'number' }),
